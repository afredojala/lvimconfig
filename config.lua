...
--
-- lvim.g.python3_host_prog = '/home/afredoja/nvim_python/.venv/bin/python'
-- CHANGE THIS TO PYTHONPATH on you computer
vim.g.python3_host_prog = '/home/afredoja/.config/nvim_python/.venv/bin/python'

-- keymappings [view all the defaults by pressing <leader>Lk]
lvim.leader = "space"
-- add your own keymapping
lvim.keys.normal_mode["<C-s>"] = ":w<cr>"
lvim.keys.normal_mode["<C-e>"] = ":vsplit <cr>"
lvim.keys.normal_mode["<leader>nt"] = ":Neogen file<cr>"
lvim.keys.normal_mode["<leader>nc"] = ":Neogen class<cr>"
lvim.keys.normal_mode["<leader>nf"] = ":Neogen func<cr>"
...
-- Telescope can be slow, disable this might increase the speed
